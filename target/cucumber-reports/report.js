...
formatter.match({
  "location": "TechGlobalSteps.userShouldSeeTokyoCityWithInfoBelowAndAnImage(DataTable)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "TechGlobalSteps.userShouldSeeDelhiCityWithInfoBelowAndAnImage(DataTable)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "TechGlobalSteps.userShouldSeeShangaiCityWithInfoBelowAndAnImage(DataTable)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "TechGlobalSteps.userShouldSeeSaoPauloCityWithInfoBelowAndAnImage(DataTable)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "TechGlobalSteps.userShouldSeeMexicoCityCityWithInfoBelowAndAnImage(DataTable)"
});
formatter.result({
  "status": "passed"
});
